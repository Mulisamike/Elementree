          ...
          <div class="container px-6 mx-auto grid">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              ...
              <?php
                    ...
                    $key = $_POST['key'];
                    $select_client = "SELECT * FROM client WHERE client_id LIKE '%" . $key .  "%' OR name LIKE '%" . $key ."%' OR phone LIKE '%" . $key ."%'"; 
                    $run_client = mysqli_query($conn, $select_client);
                    $count_clients = mysqli_num_rows($run_client);
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          ...
                          <form action="functions/deleteClient.php" method="GET">
                          <input type="hidden" name="client_id" value="<?php echo $row_client['client_id']; ?>">
                          <button type="submit"
                            class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Delete"
...
<br>
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto">
                <?php
                    $select_nominee = "SELECT * FROM nominee WHERE nominee_id LIKE '%" . $key .  "%' OR name LIKE '%" . $key ."%'";
                    $run_nominee = mysqli_query($conn, $select_nominee);
                    $count_nominees = mysqli_num_rows($run_nominee);
                ?>
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    <tr
