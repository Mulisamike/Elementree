        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            >
              ...
              <span>Add Payments &RightArrow;</span>
            </a>

            <!-- With actions -->
            <!-- <h4 class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300"> Payments </h4> -->
              ...
              <div class="w-full overflow-x-auto">
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    <?php
                        while($row_payment = mysqli_fetch_assoc($run_payments)){
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-sm">
                      R<?php echo $row_payment['amount']; ?>
                      </td>
                      <td class="px-4 py-3 text-sm">
                      <?php echo $row_payment['due']  ?>
                      </td>
                      <td class="px-4 py-3 text-sm">
                        R<?php echo $row_payment['fine']  ?>
                      </td>
